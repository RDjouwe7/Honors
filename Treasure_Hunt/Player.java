// Player.java - Handles player entity and movement
...
public class Player extends Entity {
    ...
    private GameTimer gameTimer;        // Reference to game timer
    ...
    public Player(GamePanel gp, KeyHandler keyH) {
        ...
        // Initialize timer with 180 seconds (3 minutes)
        this.gameTimer = new GameTimer(this, gp, 180);
    ...
    public void update() {
        ...
        if (keyH.upPressed || keyH.downPressed || keyH.leftPressed || keyH.rightPressed) {
            ...
            // Move if next position is valid
            if (nextRow >= 0 && nextCol >= 0 && 
                ...
                // Check if reached exit (bottom-right corner)
                if (nextRow == gp.maxScreenRow - 1 && nextCol == gp.maxScreenCol - 1) {
                    gameTimer.displayWin();
                    gameOver = true;
                }
            }
    ...
    public void draw(Graphics2D g2) {
        ...
        // Draw timer
        g2.drawString("Time: " + gameTimer.getTimeRemaining(), 10, 20);
    }
